              ...
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                <div>
                  ...
                  <div style={{ display:'flex', gap:16, marginTop:8 }}>
                    <span style={{ fontSize:12, color:'var(--green)' }}>↑ {fmt(r.total_income)}</span>
                    <span style={{ fontSize:12, color:'var(--red-light)' }}>↓ {fmt(r.total_expenses)}</span>
                  </div>
                </div>
                <div style={{ textAlign:'right' }}>
                  <div style={{ fontSize:11, color:'var(--text-muted)', textTransform:'uppercase', letterSpacing:'0.1em' }}>Margen</div>
                  <div style={{ fontFamily:'Cormorant Garamond, serif', fontSize:22, color: r.net_margin_pct>=0 ? 'var(--gold)':'var(--red-light)' }}>
            ...
            <div className="card">
              ...
              {selected.ai_summary && (
                <div>
                  ...
                  <div style={{ fontSize:14, color:'rgba(250,248,242,0.75)', lineHeight:1.8, fontFamily:'Cormorant Garamond, serif', fontStyle:'italic', fontSize:17, fontWeight:300 }}>
                    {selected.ai_summary}
                  </div>
                </div>
              )}
